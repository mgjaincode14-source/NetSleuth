...
def main():
    ...
    parser.add_argument(
        "-p", "--phase", type=int, choices=[2, 3, 4, 5, 6], default=6,
        help="Phase to execute (2: Capture Engine, 3: Packet Parser, 4: Web Dashboard, 5: Traffic Analytics, 6: Threat Detection) [Default: 6]"
    )
